...
export default {
  ...
  computed: {
    show_workout: function () {
      return this.feed_divs[+this.i].instance.show_workout;
    },
    show_exercise: function () {
      return this.feed_divs[+this.i].instance.show_exercise;
    },
    show_message: function () {
      return this.feed_divs[+this.i].instance.show_message;
    },
    date_now: function () {
      return this.feed_divs[+this.i].instance.date_now;
    },
    message_obj_from: function () {
      return this.feed_divs[+this.i].instance.message_obj_from;
    },
    message_obj_message: function () {
      return this.feed_divs[+this.i].instance.message_obj_message;
    },
    exercise_obj_message: function () {
      return this.feed_divs[+this.i].instance.exercise_obj_message;
    },
